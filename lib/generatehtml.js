...
function writeToHTML(businessList) {
    // console.log("this is in the generateHTML file")
    // console.log(businessList[0]);
    // console.log(businessList[0][0]);
    // console.log(businessList[0][0].id);
...
function generateHTML(businessList) {
    ...
    <body>
        ...
        <main class="team-area col-12 d-flex flex-wrap justify-content-center">
            
    <container class="d-flex">
        <button class="btn mx-5 button" id="view-all">View All Tables</button>
        <button class="btn mx-5 button" id="view-dept">View Departments</button>
        <button class="btn mx-5 button" id="view-role">View Roles</button>
        <button class="btn mx-5 button" id="view-emp">View Employees</button>
    </container>`;

    starterHTML += `
    <container class="container table-responsive text-nowrap m-3 p-3" id="dept-table">
    <table class="table w-auto table-hover text-center">
        <thead>
            <tr>
                <th scope="col">ID</th>
